...
For a complete real-world chatbot example, see the static
[Live Chat Demo](/live-chat-demo). The example app supports local Ollama and
cloud providers that stream Markdown responses.
